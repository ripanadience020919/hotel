                        ...
                        <div class="item ">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 " style="margin-top: 60px;opacity: 0.9;" onMouseOver="this.style.opacity='1'" onMouseOut="this.style.opacity='0.9'">
                                <a href="<?php echo base_url();?>home/hotel_details/<?php echo $value['id']; ?>">
                                    <div class="div-relative-c" style="position: relative;text-align: center;font-size: 1rem;font-weight: 400;line-height: 1.5;">
                                        <img  class="owl-lazy rounded-circle img-responsive" src="<?php echo base_url().'assets/admin/uploads/locations/'.$value['image']?>" alt="Private Vacation Homes in Alibaug" style="opacity: 1;border-radius: 50%; height: 250px;width: 250px;">
                                        <div class="overlay-center-txt" style="position: absolute;width: 94%;bottom: 43%;text-align: center;"><span class="loc-name" style="font-weight: bold;font-size: 18px;color: #8e7037;    background: white;" ><?php echo $value['l_name'];?></span>
                                        </div>
                                    </div>
                                </a>
                            </div>
    ...
    <section class="about">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-7 col-lg-7 ">
                    <div class="about-img">
                        <div class="img-1 curve">
                            <img src="<?php echo base_url();?>assets/front/images/Home-1/about-3.jpg" class="img-responsive curve" alt="Image">
                            <div class="img-2 curve">
                                <img src="<?php echo base_url();?>assets/front/images/Home-1/about-1.jpg" class="img-responsive curve" alt="Image">
                            </div>
                            <div class="img-3 curve">
                                <img src="<?php echo base_url();?>assets/front/images/Home-1/about-2.jpg" class="img-responsive curve" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
