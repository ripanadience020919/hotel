...
<html lang="en">
    ...
    <body class="loading authentication-bg authentication-bg-pattern">
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <h3>Thank You !</h3>
                                    <p class="text-muted font-14 mt-2"> Booking Successful.
                                        </p>
									<p class="text-muted font-14 mt-2">Your order ID : <?php echo $_SESSION['razorpay_order_id'];?></p>

                                    <a href="<?php echo base_url();?>home/my_profile" class="btn btn-info btn-block btn-pink waves-effect waves-light mt-3">Back to Your Dashboard</a> 
        ...
        <footer class="footer footer-alt">
            <!-- <script>document.write(new Date().getFullYear())</script> &copy; JD Wholesale <a href="#" class="text-white-50">Toolkit</a>  -->
