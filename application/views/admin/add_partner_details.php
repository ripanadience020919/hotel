...
?> -->
            <div class="content-page">
                <div class="content">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Add Partner Details</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Add Partner Details</h4>
                                </div>
                            </div>
                        </div> 
                    ...
                    ?>
                    <form  action="<?php echo base_url().'admin/addpartnerdetails'?>" method="post" enctype="multipart/form-data">                      
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
