                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active"><?=$display;?> an Amenity</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title"><?=$display;?> an Amenity</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <a href="<?php echo base_url()?>admin/amenitieslist"><button type="button" class="btn btn-blue btn-xs waves-effect waves-light" style="float: right;">Amenity List</button></a>
                                                <input type="text" id="a_name"  name="a_name" class="form-control" placeholder="e.g : AvTa" required>
                            ...
                            <div class="col-12">
                                <div class="text-center mb-3">
                                    <a href="<?php echo base_url();?>admin/amenitieslist" class="btn w-sm btn-light waves-effect">Cancel</a>
