                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?php  echo base_url().'assets/admin/uploads/locations/'.$val['image']?>" height="100px" width="100px"></td>
                                                    <td><?php echo $val['l_name'];?></td>
                                                    <!-- <td>
                                                        <?php echo $val['l_order'];?>
                                                    </td> -->
                                                    <td>
                                                        <a href="<?php echo base_url()?>admin/editlocation/<?php echo $val['id'];?>"><i class="mdi mdi-square-edit-outline" style="font-size: 20px;color: green"></i></a>

                                                        <?php
                                                            if (($this->session->userdata('role') == 1)) { 
                                                                ?>
                                                        <a href="<?php echo base_url()?>admin/deletelocation/<?php echo $val['id'];?>"><i class="mdi mdi-delete" style="font-size: 20px;color: red"></i></a>
                                                        <?php 
                                                    }
                                                    ?>
                                                    </td>
